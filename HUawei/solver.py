...
class PuzleSolver:
    ...
    def get_position(self):
        template = self.__piece_preprocessing()
        background = self.__background_preprocessing()
        background = cv2.resize(background, (283, 160),
    ...
    def __piece_preprocessing(self):
        ...
        template = self.__extend_template_boundary(img)
